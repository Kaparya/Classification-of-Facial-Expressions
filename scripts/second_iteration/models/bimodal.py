...
under the slug `ours_bilstm_bimodal`. Audio input is the SAME (1,1,64,128)
log-mel tensor consumed by the cascade gate -- the head reuses it without
any re-extraction.
"""
...
def load_bimodal() -> BiLSTMBimodal:
    ...
    ckpt_path = BIMODAL_CKPT_DIR / f"ours_bilstm_bimodal_{BIMODAL_SESSION}.pt"
